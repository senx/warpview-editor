...
(function (SeverityIcon) {
    function getSVGData(severity, theme) {
        switch (severity) {
            ...
            case Severity.Info:
                var infoColor = theme.type === LIGHT ? Color.fromHex('#007ACC') : Color.fromHex('#75BEFF');
            ...
            case Severity.Warning:
                var warningColor = theme.type === LIGHT ? Color.fromHex('#DDB100') : Color.fromHex('#fc0');
            ...
            case Severity.Error:
                var errorColor = theme.type === LIGHT ? Color.fromHex('#A1260D') : Color.fromHex('#F48771');
    ...
    SeverityIcon.getSVGData = getSVGData;
...
function getCSSRule(severity, theme) {
